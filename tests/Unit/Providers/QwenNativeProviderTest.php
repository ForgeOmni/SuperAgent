...
class QwenNativeProviderTest extends TestCase
{
    ...
    {
        $this->expectException(ProviderException::class);
        new QwenNativeProvider(['api_key' => 'k', 'region' => 'eu']);
    }
    ...
    private function host(QwenNativeProvider $p): string
    {
